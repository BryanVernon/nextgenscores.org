...
Scheduled invocations occur at minute 17 of every hour. Render permits a refresh at 7 AM and 7 PM daily, plus every hour from 11 AM through 11 PM on Saturdays, in `America/Chicago`. This keeps the requested times accurate through daylight-saving changes. A manual workflow dispatch bypasses that time gate.
